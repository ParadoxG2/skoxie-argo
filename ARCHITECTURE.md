...
│           ▼                ▼                ▼                 ▼  │
│  ┌────────────────┐ ┌──────────────┐ ┌──────────────┐ ┌─────────┐│
│  │   Pangolin     │ │  Demo Apps   │ │   ArgoCD     │ │  Your  ││
...
### Authentication
- **Pangolin**: ForwardAuth middleware
- **OAuth**: Optional OAuth provider integration
- **Session**: Cookie-based sessions
- **Domain**: `.woxie.xyz` (all subdomains)

### Secrets Management
- **Cloudflare API Token**: Multiple secrets in different namespaces
- **OAuth Credentials**: Pangolin namespace
- **Session Secrets**: Pangolin namespace
...
```
┌──────┐     ┌─────────┐     ┌──────────┐     ┌────────────┐
│ User │────▶│ Traefik │────▶│ Pangolin │────▶│ OAuth Idp  │
└──────┘     └─────────┘     └──────────┘     └────────────┘
...
- `thomseddon/traefik-forward-auth` (ForwardAuth for Pangolin)
